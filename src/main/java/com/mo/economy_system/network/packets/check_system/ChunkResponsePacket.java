 ...
 */
public class ChunkResponsePacket {
    /**
     * 用于缓存所有正在接收的分块。
     * key = fileId (String)
    ...
    public ChunkResponsePacket(String playerName, String playerUUID, String senderName, String senderUUID, String actionType, String fileName, String fileId, int chunkIndex, int totalChunks, String chunkData) {
    ...
    // 编码
    public static void encode(ChunkResponsePacket msg, FriendlyByteBuf buf) {
    ...
    // 解码
    public static ChunkResponsePacket decode(FriendlyByteBuf buf) {
        ...
        return new ChunkResponsePacket(playerName, playerUUID, senderName, senderUUID, actionType, fileName, fileId, idx, total, data);
    }

    // 处理
    public static void handle(ChunkResponsePacket msg, Supplier<NetworkEvent.Context> contextSupplier) {
